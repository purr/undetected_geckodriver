...
class TestPatch(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = undetected_geckodriver.Firefox(lookup_path=overridden_path)
    ...
    def test_patch(self):
        ...
        self.assertFalse(b"webdriver" in libxul_data)

    def test_webdriver_gone(self):
        self.assertTrue(self.driver.execute_script("return navigator !== null"))
        self.assertIsNone(self.driver.execute_script("return navigator.webdriver"))
